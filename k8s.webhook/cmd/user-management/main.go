...
import (
	...
	"scabarrus.com/k8s.webhook/internal/liveness"
	"scabarrus.com/k8s.webhook/internal/service"
	"scabarrus.com/k8s.webhook/middleware"
)
...
func main (){
	...
	r.HandleFunc("/api/v1/groups/{group}/members", groupMemberService.FindAll).Methods("GET")
